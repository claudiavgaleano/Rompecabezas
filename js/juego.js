//Variables globales 
var movimientosRestantes = 60;


// Arreglo que contiene las intrucciones del juego 
var instrucciones = ["Utilizá las flechas del teclado para mover las piezas", 
"Ordená las piezas hasta formar la imagen que se muestra como modelo", "No hay tiempo límite", "Tenés 30 movimientos"];
...
function cerrarCartelGanador() {
  document.getElementById("sombra").style.display="none";
  document.getElementById("cartelGanador").style.display="none";
  document.getElementById("cartelPerdedor").style.display="none";
  
}

function mostrarCartelPerdedor() {      
    document.getElementById("sombra").style.display="block";
    document.getElementById("cartelPerdedor").style.display="block"; 
}
...
function moverEnDireccion(direccion) {
  ...
  document.getElementById('movimientosRestantes').value =  movimientosRestantes;
